...
public interface AdminMng{
    ...
    public Admin register(String username, String password, String email, String ip, Boolean disabled, Website website,Boolean viewonlyAdmin,String channelId,String channelName,String commerceId,String commerceName,String storeFront);
