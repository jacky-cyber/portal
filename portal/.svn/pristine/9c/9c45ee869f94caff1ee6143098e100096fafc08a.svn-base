...
public class GatheringAct {
	...
	public String listAll(String accountNumber,String code,Integer pageNo, HttpServletRequest request, ModelMap model) {
		...
		Pagination pagination = manager.getPage(chanId,comId,accountNumber, code, cpn(pageNo), CookieUtils.getPageSize(request));
    ...
    public String list(Integer pageNo, HttpServletRequest request, ModelMap model) {
        Pagination pagination = manager.getPage(null,null,"","",cpn(pageNo), CookieUtils
                .getPageSize(request));
        model.addAttribute("pagination",pagination);
        return "Gathering/list";
    }
