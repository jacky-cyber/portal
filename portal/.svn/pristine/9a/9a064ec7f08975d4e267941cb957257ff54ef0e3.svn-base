...
public class AdminMngImpl  implements AdminMng{
    ...
    public Admin register(String username, String password, String email,
    		String ip, Boolean disabled,Website website,Boolean viewonlyAdmin,String channelId,String channelName,String commerceId,String commerceName,String storeFront){
        Admin entity = new Admin();
        Timestamp timestamp = new Timestamp(System.currentTimeMillis());
        com.jspgou.core.entity.User user = userMng.register(username, password, email, ip, timestamp ,channelId,channelName,commerceId,commerceName,storeFront);
