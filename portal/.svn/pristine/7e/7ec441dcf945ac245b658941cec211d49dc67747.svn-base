...
public class CaptchaServiceSingleton {
	...
	public static ImageCaptchaService generatorCaptchaService() {
        ...
        RandomWordGenerator rg = new RandomWordGenerator("123456789abcdefghjkmnpqrstuvwxyz");
		GimpyFactory gf = new GimpyFactory(rg, cwti);

		GenericCaptchaEngine gce = new GenericCaptchaEngine(
				new CaptchaFactory[] { gf });
		// 返回一个Service对象，这里180是验证码存在的时间，单位是秒，200000是最大存储大小
		return new GenericManageableCaptchaService(gce, 180, 200000);
	}
}