...
Source Database       : jspgou

Target Server Type    : MYSQL
Target Server Version : 50620
File Encoding         : 65001

Date: 2015-02-05 14:07:01
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for jc_address
-- ----------------------------
DROP TABLE IF EXISTS `jc_address`;
CREATE TABLE `jc_address` (
  ...
  CONSTRAINT `fk_jc_address_parent` FOREIGN KEY (`parent_id`) REFERENCES `jc_address` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='省、市、县表';

-- ----------------------------
-- Records of jc_address
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_core_admin
-- ----------------------------
DROP TABLE IF EXISTS `jc_core_admin`;
CREATE TABLE `jc_core_admin` (
  ...
  CONSTRAINT `fk_jc_admin_user` FOREIGN KEY (`user_id`) REFERENCES `jc_core_user` (`user_id`),
  CONSTRAINT `fk_jc_admin_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='核心管理员表';

-- ----------------------------
-- Records of jc_core_admin
-- ----------------------------
INSERT INTO `jc_core_admin` VALUES ('1', '1', '1', '2009-06-13 00:00:00', '0', '0');
INSERT INTO `jc_core_admin` VALUES ('2', '1', '5', '2014-07-12 11:03:23', '0', '1');
INSERT INTO `jc_core_admin` VALUES ('3', '1', '7', '2014-10-15 10:43:42', '0', '0');
INSERT INTO `jc_core_admin` VALUES ('4', '1', '8', '2014-11-06 17:28:18', '0', '0');

-- ----------------------------
-- Table structure for jc_core_admin_role
-- ----------------------------
DROP TABLE IF EXISTS `jc_core_admin_role`;
CREATE TABLE `jc_core_admin_role` (
  ...
  CONSTRAINT `fk_jc_core_admin_role` FOREIGN KEY (`admin_id`) REFERENCES `jc_core_admin` (`admin_id`),
  CONSTRAINT `fk_jc_core_role_admin` FOREIGN KEY (`role_id`) REFERENCES `jc_core_role` (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of jc_core_admin_role
-- ----------------------------
INSERT INTO `jc_core_admin_role` VALUES ('1', '1');
INSERT INTO `jc_core_admin_role` VALUES ('1', '2');
INSERT INTO `jc_core_admin_role` VALUES ('1', '3');
INSERT INTO `jc_core_admin_role` VALUES ('2', '4');

-- ----------------------------
-- Table structure for jc_core_global
-- ----------------------------
DROP TABLE IF EXISTS `jc_core_global`;
...
CREATE TABLE `jc_core_log` (
  ...
  CONSTRAINT `fk_jc_log_site` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`),
  CONSTRAINT `fk_jc_log_user` FOREIGN KEY (`user_id`) REFERENCES `jc_core_user` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='jspgou日志表';

-- ----------------------------
-- Records of jc_core_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_core_member
-- ----------------------------
DROP TABLE IF EXISTS `jc_core_member`;
CREATE TABLE `jc_core_member` (
  ...
  CONSTRAINT `fk_jc_member_user` FOREIGN KEY (`user_id`) REFERENCES `jc_core_user` (`user_id`),
  CONSTRAINT `fk_jc_member_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='核心会员表';

-- ----------------------------
-- Records of jc_core_member
-- ----------------------------
INSERT INTO `jc_core_member` VALUES ('1', '1', '1', '2009-07-06 00:00:00', '0', '1', null);
...
INSERT INTO `jc_core_member` VALUES ('6', '7', '1', '2014-10-15 10:44:00', '0', '1', null);
INSERT INTO `jc_core_member` VALUES ('7', '8', '1', '2014-11-06 17:29:06', '0', '1', null);
INSERT INTO `jc_core_member` VALUES ('8', '9', '1', '2015-02-04 16:24:36', '0', '1', null);

-- ----------------------------
-- Table structure for jc_core_message_tpl
-- ----------------------------
DROP TABLE IF EXISTS `jc_core_message_tpl`;
CREATE TABLE `jc_core_message_tpl` (
  ...
  CONSTRAINT `fk_jc_msgtpl_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='信息模板';

-- ----------------------------
-- Records of jc_core_message_tpl
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_core_role
-- ----------------------------
DROP TABLE IF EXISTS `jc_core_role`;
...
-- ----------------------------
-- Records of jc_core_role
-- ----------------------------
INSERT INTO `jc_core_role` VALUES ('1', '管理员', '10', '1');
INSERT INTO `jc_core_role` VALUES ('2', 'test', '10', '0');

-- ----------------------------
-- Table structure for jc_core_role_permission
-- ----------------------------
DROP TABLE IF EXISTS `jc_core_role_permission`;
CREATE TABLE `jc_core_role_permission` (
  `role_id` int(11) NOT NULL DEFAULT '0',
  `uri` varchar(100) NOT NULL DEFAULT '',
  KEY `fk_jc_core_permission_role` (`role_id`),
  CONSTRAINT `fk_jc_core_permission_role` FOREIGN KEY (`role_id`) REFERENCES `jc_core_role` (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='角色授权表';

-- ----------------------------
-- Records of jc_core_role_permission
-- ----------------------------
...
INSERT INTO `jc_core_role_permission` VALUES ('2', '/popularityGroup/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/top.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/admin/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/shipping/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/config/v_qqEdit.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/config/v_qqList.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/payment/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/right.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/frame/marketing');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/left.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/commonAdmin/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/config/v_qqAdd.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/plugins/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/logistics/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/config/o_qqSave.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/config/v_email_edit.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/type/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/config/v_basic_edit.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/role/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/config/o_qqDelete.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/main.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/exchange/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/index.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/config/o_global_update.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/logout.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/config/o_qqUpdate.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/config/v_global_edit.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/frame/config');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/gift/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/coupon/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/config/o_email_update.do');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/log/');
INSERT INTO `jc_core_role_permission` VALUES ('2', '/config/o_basic_update.do');

-- ----------------------------
-- Table structure for jc_core_user
-- ----------------------------
DROP TABLE IF EXISTS `jc_core_user`;
...
-- ----------------------------
-- Records of jc_core_user
-- ----------------------------
INSERT INTO `jc_core_user` VALUES ('1', 'admin', 'admin@hotmail.com', '5f4dcc3b5aa765d61d8327deb882cf99', '2009-08-22 00:00:00', '2487', null, '2015-02-04 18:10:31', '127.0.0.1', '2015-02-05 09:13:16', '127.0.0.1', null, null, null, '0');
...
INSERT INTO `jc_core_user` VALUES ('7', 'test3', 'test3@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '2014-10-15 10:43:42', '1', '127.0.0.1', '2014-10-15 10:43:57', '127.0.0.1', '2014-10-15 10:43:57', '127.0.0.1', null, null, null, '0');
INSERT INTO `jc_core_user` VALUES ('8', 'test4', 'test4@test.com', 'e10adc3949ba59abbe56e057f20f883e', '2014-11-06 17:28:18', '10', '127.0.0.1', '2014-11-07 11:02:47', '127.0.0.1', '2014-11-07 11:04:50', '127.0.0.1', null, null, null, '0');
INSERT INTO `jc_core_user` VALUES ('9', 'David', 'test@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '2015-02-04 16:24:36', '0', '127.0.0.1', null, null, null, null, null, null, null, '0');

-- ----------------------------
-- Table structure for jc_core_website
-- ----------------------------
DROP TABLE IF EXISTS `jc_core_website`;
CREATE TABLE `jc_core_website` (
  ...
  CONSTRAINT `fk_jc_website_admin` FOREIGN KEY (`admin_id`) REFERENCES `jc_core_admin` (`admin_id`),
  CONSTRAINT `fk_jc_website_global` FOREIGN KEY (`global_id`) REFERENCES `jc_core_global` (`global_id`),
  CONSTRAINT `fk_jc_website_parent` FOREIGN KEY (`parent_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='站点表';

-- ----------------------------
-- Records of jc_core_website
-- ----------------------------
INSERT INTO `jc_core_website` VALUES ('1', '1', '1', null, '192.168.0.144', 'jeegou开发站', '- Powered by JSPGOU', 'jspgou', '.htm', '1', '2', '2009-06-13 00:00:00', '', null, null, '网站暂时关闭', '0', 'GBK', 'text/html; charset=gbk', 'zh_CN', 'zh_CN', null, '4', null, null, '', '', '', '', '', '', '1', 'smtp.163.com', 'UTF-8', 'jspgou@163.com', '百年老店', 'password', '4.5', '0');

-- ----------------------------
-- Table structure for jc_data_backup
-- ----------------------------
DROP TABLE IF EXISTS `jc_data_backup`;
...
-- ----------------------------
-- Records of jc_data_backup
-- ----------------------------
INSERT INTO `jc_data_backup` VALUES ('1', 'C:\\\\Program Files\\\\MySQL\\\\MySQL Server 5.0\\\\bin\\\\', 'localhost', 'gou', 'root', 'password');

-- ----------------------------
-- Table structure for jc_online_customerservice
-- ----------------------------
DROP TABLE IF EXISTS `jc_online_customerservice`;
...
-- ----------------------------
-- Records of jc_online_customerservice
-- ----------------------------
INSERT INTO `jc_online_customerservice` VALUES ('1', 'jspgou', '1220788677', '10', '0', 'QQ');
INSERT INTO `jc_online_customerservice` VALUES ('2', '阿里', 'jeecms丶张', '10', '0', 'Ali');

-- ----------------------------
-- Table structure for jc_popularity_group
-- ----------------------------
DROP TABLE IF EXISTS `jc_popularity_group`;
...
-- ----------------------------
-- Records of jc_popularity_group
-- ----------------------------
INSERT INTO `jc_popularity_group` VALUES ('19', 'test', '45647.11', '', '60.00');
INSERT INTO `jc_popularity_group` VALUES ('20', 'test2', '0.11', '', '0.01');
INSERT INTO `jc_popularity_group` VALUES ('21', 'test', '40000.00', '', '1.00');

-- ----------------------------
-- Table structure for jc_popularity_group_product
-- ----------------------------
DROP TABLE IF EXISTS `jc_popularity_group_product`;
CREATE TABLE `jc_popularity_group_product` (
  ...
  CONSTRAINT `fk_jc_popularity_product_group` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`),
  CONSTRAINT `jc_popularity_group_product` FOREIGN KEY (`Id`) REFERENCES `jc_popularity_group` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='组合购买商品表';

-- ----------------------------
-- Records of jc_popularity_group_product
-- ----------------------------
...
INSERT INTO `jc_popularity_group_product` VALUES ('21', '3');

-- ----------------------------
-- Table structure for jc_popularity_item
-- ----------------------------
DROP TABLE IF EXISTS `jc_popularity_item`;
CREATE TABLE `jc_popularity_item` (
  ...
  CONSTRAINT `fk_jc_shop_popularityitem_cart` FOREIGN KEY (`cart_id`) REFERENCES `jc_shop_cart` (`cart_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='购物车';

-- ----------------------------
-- Records of jc_popularity_item
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_admin
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_admin`;
CREATE TABLE `jc_shop_admin` (
  ...
  CONSTRAINT `fk_jc_shop_admin_core` FOREIGN KEY (`admin_id`) REFERENCES `jc_core_admin` (`admin_id`),
  CONSTRAINT `fk_jc_shop_admin_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商城管理员';

-- ----------------------------
-- Records of jc_shop_admin
-- ----------------------------
INSERT INTO `jc_shop_admin` VALUES ('1', '1', '', null);
INSERT INTO `jc_shop_admin` VALUES ('2', '1', '', null);
INSERT INTO `jc_shop_admin` VALUES ('3', '1', '', null);
INSERT INTO `jc_shop_admin` VALUES ('4', '1', '', null);

-- ----------------------------
-- Table structure for jc_shop_advertise
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_advertise`;
CREATE TABLE `jc_shop_advertise` (
  ...
  CONSTRAINT `jc_shop_adspace_fk` FOREIGN KEY (`adspace_id`) REFERENCES `jc_shop_advertise_space` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='广告';

-- ----------------------------
-- Records of jc_shop_advertise
-- ----------------------------
INSERT INTO `jc_shop_advertise` VALUES ('1', '1', '.net云计算1', '1', '1968', '0', null, null, '1');

-- ----------------------------
-- Table structure for jc_shop_advertise_attr
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_advertise_attr`;
CREATE TABLE `jc_shop_advertise_attr` (
  ...
  CONSTRAINT `jc_shop_advertise_fk` FOREIGN KEY (`Id`) REFERENCES `jc_shop_advertise` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of jc_shop_advertise_attr
-- ----------------------------
INSERT INTO `jc_shop_advertise_attr` VALUES ('1', 'image_url', '/jspgou/u/201407/091116578hgi.jpg');
...
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_advertise_space`;
...
-- ----------------------------
-- Records of jc_shop_advertise_space
-- ----------------------------
INSERT INTO `jc_shop_advertise_space` VALUES ('1', '页头广告位', '页头广告位', '1');

-- ----------------------------
-- Table structure for jc_shop_article
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_article`;
CREATE TABLE `jc_shop_article` (
  ...
  CONSTRAINT `fk_jc_shop_article_channel` FOREIGN KEY (`channel_id`) REFERENCES `jc_shop_channel` (`channel_id`),
  CONSTRAINT `fk_jc_shop_article_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='商城文章表';

-- ----------------------------
-- Records of jc_shop_article
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_article_content
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_article_content`;
CREATE TABLE `jc_shop_article_content` (
  `article_id` bigint(20) NOT NULL,
  `content` longtext,
  KEY `fk_jc_shop_content_article` (`article_id`),
  CONSTRAINT `fk_jc_shop_content_article` FOREIGN KEY (`article_id`) REFERENCES `jc_shop_article` (`article_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商城文章内容';

-- ----------------------------
-- Records of jc_shop_article_content
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_brand
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_brand`;
CREATE TABLE `jc_shop_brand` (
  ...
  CONSTRAINT `fk_jc_shop_brand_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='品牌';

-- ----------------------------
-- Records of jc_shop_brand
-- ----------------------------
INSERT INTO `jc_shop_brand` VALUES ('1', '1', '森马', '', 'http://www.semir.com', '/jspgou/u/201405/26084559f4fx.gif', '1', '0', '0', 's');
INSERT INTO `jc_shop_brand` VALUES ('2', '1', '摩托罗拉', '', 'http://www.motorola.com.cn/', '/jspgou/u/201405/26084614quwz.png', '10', '0', '0', 'm');
INSERT INTO `jc_shop_brand` VALUES ('3', '1', 'iPhone', '', 'http://www.apple.com/', '/jspgou/u/201405/26084706lpep.jpg', '10', '0', '0', 'i');
INSERT INTO `jc_shop_brand` VALUES ('4', '1', '联想', '联想', 'http://www.lenovo.com.cn/', '/jspgou/u/201406/17114011pzq7.gif', '10', '0', '0', 'l');
INSERT INTO `jc_shop_brand` VALUES ('5', '1', '美的', '美的', 'http://www.midea.com/cn/', '/jspgou/u/201406/17114535if8u.png', '10', '0', '0', 'm');
...
-- ----------------------------
-- Table structure for jc_shop_brand_text
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_brand_text`;
CREATE TABLE `jc_shop_brand_text` (
  `brand_id` bigint(20) NOT NULL,
  `text` longtext COMMENT '详细信息',
  PRIMARY KEY (`brand_id`),
  CONSTRAINT `fk_jc_shop_text_brand` FOREIGN KEY (`brand_id`) REFERENCES `jc_shop_brand` (`brand_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of jc_shop_brand_text
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_cardgift
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_cardgift`;
CREATE TABLE `jc_shop_cardgift` (
  ...
  CONSTRAINT `fk_jc_cardgift_cart` FOREIGN KEY (`cartId`) REFERENCES `jc_shop_cart` (`cart_id`),
  CONSTRAINT `fk_jc_cardgift_gift` FOREIGN KEY (`giftId`) REFERENCES `jc_shop_gift` (`Id`),
  CONSTRAINT `fk_jc_cardgift_website` FOREIGN KEY (`websiteId`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of jc_shop_cardgift
-- ----------------------------
...
CREATE TABLE `jc_shop_cart` (
  ...
  CONSTRAINT `fk_jc_shop_cart_member` FOREIGN KEY (`cart_id`) REFERENCES `jc_shop_member` (`member_id`),
  CONSTRAINT `fk_jc_shop_cart_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='购物车';

-- ----------------------------
-- Records of jc_shop_cart
-- ----------------------------
INSERT INTO `jc_shop_cart` VALUES ('1', '1', '2', null);

-- ----------------------------
-- Table structure for jc_shop_cart_item
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_cart_item`;
CREATE TABLE `jc_shop_cart_item` (
  ...
  CONSTRAINT `fk_jc_shop_cartitem_cart` FOREIGN KEY (`cart_id`) REFERENCES `jc_shop_cart` (`cart_id`),
  CONSTRAINT `fk_jc_shop_cartitem_product` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`),
  CONSTRAINT `fk_jc_shop_cartitem_productFash` FOREIGN KEY (`productFash_id`) REFERENCES `jc_shop_product_fashion` (`fashion_id`),
  CONSTRAINT `fk_jc_shop_cartitem_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='购物车';

-- ----------------------------
-- Records of jc_shop_cart_item
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_category
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_category`;
CREATE TABLE `jc_shop_category` (
  ...
  CONSTRAINT `fk_jc_shop_category_parent` FOREIGN KEY (`parent_id`) REFERENCES `jc_shop_category` (`category_id`),
  CONSTRAINT `fk_jc_shop_category_ptype` FOREIGN KEY (`ptype_id`) REFERENCES `jc_shop_ptype` (`ptype_id`),
  CONSTRAINT `fk_jc_shop_cateory_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='类别';

-- ----------------------------
-- Records of jc_shop_category
-- ----------------------------
...
INSERT INTO `jc_shop_category` VALUES ('3', '1', '8', '1', '手机', 'shouji', '2', '3', '1', '', '', '/category/分类.html', '/product/商品.html', '/jspgou/u/201405/23140259och6.jpg', '', '1');
INSERT INTO `jc_shop_category` VALUES ('4', '1', '2', '2', '女装', 'woman', '14', '15', '10', '', '', '', '', '/jspgou/u/201405/231405489rv9.gif', '', '1');
INSERT INTO `jc_shop_category` VALUES ('5', '1', '9', '1', '笔记本', 'bjb', '4', '5', '2', '', '', '', '', '/jspgou/u/201406/17115058ic2f.jpg', '', '1');
...
INSERT INTO `jc_shop_category` VALUES ('10', '1', '1', '1', '台式机', 'tsj', '6', '7', '10', '', '', '/category/分类.html', '/product/商品.html', '/jspgou/u/201406/171352362dn3.jpg', '', '0');
INSERT INTO `jc_shop_category` VALUES ('11', '1', '1', '1', '办公', 'bg', '8', '9', '10', '', '', '', '', '/jspgou/u/201406/17135424g50b.jpg', '', '0');
INSERT INTO `jc_shop_category` VALUES ('12', '1', '1', '1', '相机', 'xj', '10', '11', '10', '', '', '', '', '/jspgou/u/201406/17135611o9rv.jpg', '', '0');
INSERT INTO `jc_shop_category` VALUES ('13', '1', '2', '2', '男装', 'man', '16', '17', '10', '', '', '', '', '/jspgou/u/201406/171358477227.jpg', '', '0');
INSERT INTO `jc_shop_category` VALUES ('14', '1', '2', '2', '童装', 'child', '18', '19', '10', '', '', '', '', '/jspgou/u/201406/17135932xem2.jpg', '', '0');
INSERT INTO `jc_shop_category` VALUES ('15', '1', '2', '2', '内衣', 'neiyi', '20', '21', '10', '', '', '', '', '/jspgou/u/201406/17140013u2gx.jpg', '', '0');
INSERT INTO `jc_shop_category` VALUES ('16', '1', '2', '2', '裤子', 'kuzi', '22', '23', '10', '', '', '', '', '/jspgou/u/201406/17140102a9n3.jpg', '', '0');
INSERT INTO `jc_shop_category` VALUES ('17', '1', '3', '6', '女包', 'nvbao', '26', '27', '10', '', '', '', '', '/jspgou/u/201406/17140251zg8t.gif', '', '0');
INSERT INTO `jc_shop_category` VALUES ('18', '1', '3', '6', '男鞋', 'nanxie', '28', '29', '10', '', '', '', '', '/jspgou/u/201406/17140420kg46.jpg', '', '0');
INSERT INTO `jc_shop_category` VALUES ('19', '1', '3', '6', '童鞋', 'tongxie', '30', '31', '10', '', '', '', '', '/jspgou/u/201406/17140512r68w.jpg', '', '0');
INSERT INTO `jc_shop_category` VALUES ('20', '1', '3', '6', '女鞋', 'nvxie', '32', '33', '10', '', '', '', '', '/jspgou/u/201406/171406077u7h.jpg', '', '0');
INSERT INTO `jc_shop_category` VALUES ('21', '1', '3', '6', '男包', 'nanbao', '34', '35', '10', '', '', '', '', '/jspgou/u/201406/17140806p11u.jpg', '', '0');
INSERT INTO `jc_shop_category` VALUES ('22', '1', '12', null, '电影票', 'ticket', '41', '44', '10', '电影票', '电影票', '', '/product/电影票.html', '', '电影票', '0');
INSERT INTO `jc_shop_category` VALUES ('23', '1', '12', '22', '3D电影', '3Dticket', '42', '43', '10', '3D电影', '3D电影', '', '/product/电影票.html', '', '3D电影', '0');

-- ----------------------------
-- Table structure for jc_shop_category_attr
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_category_attr`;
CREATE TABLE `jc_shop_category_attr` (
  ...
  CONSTRAINT `fK_jc_shop_category_attr` FOREIGN KEY (`category_id`) REFERENCES `jc_shop_category` (`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='jspgou类型扩展属性表';

-- ----------------------------
-- Records of jc_shop_category_attr
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_category_brand
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_category_brand`;
CREATE TABLE `jc_shop_category_brand` (
  ...
  CONSTRAINT `fk_jc_shop_brand_category` FOREIGN KEY (`brand_id`) REFERENCES `jc_shop_brand` (`brand_id`),
  CONSTRAINT `fk_jc_shop_category_brand` FOREIGN KEY (`category_id`) REFERENCES `jc_shop_category` (`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of jc_shop_category_brand
-- ----------------------------
...
INSERT INTO `jc_shop_category_brand` VALUES ('1', '22');
INSERT INTO `jc_shop_category_brand` VALUES ('2', '22');
INSERT INTO `jc_shop_category_brand` VALUES ('3', '22');
INSERT INTO `jc_shop_category_brand` VALUES ('4', '22');
INSERT INTO `jc_shop_category_brand` VALUES ('5', '22');
INSERT INTO `jc_shop_category_brand` VALUES ('6', '22');
INSERT INTO `jc_shop_category_brand` VALUES ('7', '22');
INSERT INTO `jc_shop_category_brand` VALUES ('1', '23');
INSERT INTO `jc_shop_category_brand` VALUES ('2', '23');
INSERT INTO `jc_shop_category_brand` VALUES ('3', '23');
INSERT INTO `jc_shop_category_brand` VALUES ('4', '23');
INSERT INTO `jc_shop_category_brand` VALUES ('5', '23');
INSERT INTO `jc_shop_category_brand` VALUES ('6', '23');
INSERT INTO `jc_shop_category_brand` VALUES ('7', '23');

-- ----------------------------
-- Table structure for jc_shop_category_property
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_category_property`;
CREATE TABLE `jc_shop_category_property` (
  ...
  CONSTRAINT `fk_jc_shop_category_property` FOREIGN KEY (`category_id`) REFERENCES `jc_shop_category` (`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='类型属性表';

-- ----------------------------
-- Records of jc_shop_category_property
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_category_sdtype
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_category_sdtype`;
CREATE TABLE `jc_shop_category_sdtype` (
  ...
  CONSTRAINT `fk_jc_shop_category_sdtype` FOREIGN KEY (`category_id`) REFERENCES `jc_shop_category` (`category_id`),
  CONSTRAINT `fk_jc_shop_sdtype_category` FOREIGN KEY (`standardtype_id`) REFERENCES `jc_standard_type` (`standardtype_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='类别和规则类型关联表';

-- ----------------------------
-- Records of jc_shop_category_sdtype
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_channel
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_channel`;
CREATE TABLE `jc_shop_channel` (
  ...
  CONSTRAINT `fk_jc_shop_channel_parent` FOREIGN KEY (`parent_id`) REFERENCES `jc_shop_channel` (`channel_id`),
  CONSTRAINT `fk_jc_shop_channel_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='商城栏目表';

-- ----------------------------
-- Records of jc_shop_channel
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_channel_content
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_channel_content`;
CREATE TABLE `jc_shop_channel_content` (
  `channel_id` bigint(20) NOT NULL,
  `content` longtext,
  KEY `fk_jc_shop_content_channel` (`channel_id`),
  CONSTRAINT `fk_jc_shop_content_channel` FOREIGN KEY (`channel_id`) REFERENCES `jc_shop_channel` (`channel_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='栏目内容';

-- ----------------------------
-- Records of jc_shop_channel_content
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_collect
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_collect`;
CREATE TABLE `jc_shop_collect` (
  ...
  CONSTRAINT `fk_jc_shop_collect_fashion` FOREIGN KEY (`fashion_id`) REFERENCES `jc_shop_product_fashion` (`fashion_id`),
  CONSTRAINT `fk_jc_shop_collect_member` FOREIGN KEY (`member_id`) REFERENCES `jc_shop_member` (`member_id`),
  CONSTRAINT `fk_jc_shop_collect_product` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='收藏商品';

-- ----------------------------
-- Records of jc_shop_collect
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_config
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_config`;
CREATE TABLE `jc_shop_config` (
  ...
  CONSTRAINT `fk_jc_shop_config_group` FOREIGN KEY (`register_group_id`) REFERENCES `jc_shop_member_group` (`group_id`),
  CONSTRAINT `fk_jc_shop_config_website` FOREIGN KEY (`config_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商城配置表';

-- ----------------------------
-- Records of jc_shop_config
-- ----------------------------
INSERT INTO `jc_shop_config` VALUES ('1', '商城价', '市场价', '200', '1', '1');

-- ----------------------------
-- Table structure for jc_shop_consult
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_consult`;
CREATE TABLE `jc_shop_consult` (
  ...
  CONSTRAINT `fk_member_consult` FOREIGN KEY (`member_id`) REFERENCES `jc_shop_member` (`member_id`),
  CONSTRAINT `fk_product_consult` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='购买商品咨询表';

-- ----------------------------
-- Records of jc_shop_consult
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_coupon
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_coupon`;
CREATE TABLE `jc_shop_coupon` (
  ...
  CONSTRAINT `jc_shop_coupon_ibfk_2` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='优惠劵';

-- ----------------------------
-- Records of jc_shop_coupon
-- ----------------------------
INSERT INTO `jc_shop_coupon` VALUES ('1', '1', '优惠券', '2014-08-12 10:55:01', '2014-08-29 10:55:04', '/jspgou/u/201408/20141935bnbf.jpg', '1', '50.00', '0.00', '10');

-- ----------------------------
-- Table structure for jc_shop_dictionary
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_dictionary`;
CREATE TABLE `jc_shop_dictionary` (
  ...
  CONSTRAINT `fk_jc_dictionary_type` FOREIGN KEY (`type_id`) REFERENCES `jc_shop_dictionary_type` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='字典表';

-- ----------------------------
-- Records of jc_shop_dictionary
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_dictionary_type
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_dictionary_type`;
...
-- ----------------------------
-- Records of jc_shop_dictionary_type
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_discuss
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_discuss`;
CREATE TABLE `jc_shop_discuss` (
  ...
  CONSTRAINT `fk_jc_disucss_member` FOREIGN KEY (`member_id`) REFERENCES `jc_shop_member` (`member_id`),
  CONSTRAINT `fk_jc_disucss_product` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='商品评论表';

-- ----------------------------
-- Records of jc_shop_discuss
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_exended
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_exended`;
...
-- ----------------------------
-- Records of jc_shop_exended
-- ----------------------------
INSERT INTO `jc_shop_exended` VALUES ('1', '价格', 'price', '2', '10');
INSERT INTO `jc_shop_exended` VALUES ('2', '尺寸', 'measure', '2', '10');

-- ----------------------------
-- Table structure for jc_shop_exended_item
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_exended_item`;
...
-- ----------------------------
-- Records of jc_shop_exended_item
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_fashion_standard
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_fashion_standard`;
CREATE TABLE `jc_shop_fashion_standard` (
  ...
  CONSTRAINT `fk_jc_shop_fashion_standard` FOREIGN KEY (`fashion_id`) REFERENCES `jc_shop_product_fashion` (`fashion_id`),
  CONSTRAINT `fk_jc_shop_standard_fashion` FOREIGN KEY (`standard_id`) REFERENCES `jc_standard` (`standard_id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='商品规格表';

-- ----------------------------
-- Records of jc_shop_fashion_standard
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_gift
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_gift`;
...
-- ----------------------------
-- Records of jc_shop_gift
-- ----------------------------
INSERT INTO `jc_shop_gift` VALUES ('1', '天天', '400', '1', '/jspgou/u/201407/09112222y6v6.png', '1', '');
INSERT INTO `jc_shop_gift` VALUES ('2', 'test', '10000', '0', '/jspgou/u/201407/09112204ybg6.png', '1', '');

-- ----------------------------
-- Table structure for jc_shop_gift_exchange
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_gift_exchange`;
CREATE TABLE `jc_shop_gift_exchange` (
  ...
  CONSTRAINT `fk_jc_shop_exchange_gift` FOREIGN KEY (`gift_id`) REFERENCES `jc_shop_gift` (`Id`),
  CONSTRAINT `fk_jc_shop_exchange_member` FOREIGN KEY (`member_id`) REFERENCES `jc_shop_member` (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='积分兑换';

-- ----------------------------
-- Records of jc_shop_gift_exchange
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_keyword_q
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_keyword_q`;
...
-- ----------------------------
-- Records of jc_shop_keyword_q
-- ----------------------------
INSERT INTO `jc_shop_keyword_q` VALUES ('5', '数码', '396');
INSERT INTO `jc_shop_keyword_q` VALUES ('6', '服装', '43');
INSERT INTO `jc_shop_keyword_q` VALUES ('7', '日用百货', '47');
...
INSERT INTO `jc_shop_keyword_q` VALUES ('53', 'test', '8');
INSERT INTO `jc_shop_keyword_q` VALUES ('54', '请输入关键词', '1');

-- ----------------------------
-- Table structure for jc_shop_logistics
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_logistics`;
...
-- ----------------------------
-- Records of jc_shop_logistics
-- ----------------------------
INSERT INTO `jc_shop_logistics` VALUES ('4', '圆通速递', 'http://www.yto.net.cn', '/jspgou/u/201406/0513273912gq.png', '10');
INSERT INTO `jc_shop_logistics` VALUES ('5', '顺丰速递', 'http://www.sf-express.com', '/jspgou/u/201406/05133220gtct.png', '10');

-- ----------------------------
-- Table structure for jc_shop_logistics_text
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_logistics_text`;
...
CREATE TABLE `jc_shop_member` (
  ...
  CONSTRAINT `fk_jc_shop_dictionary_familymembers` FOREIGN KEY (`familymembers_id`) REFERENCES `jc_shop_dictionary` (`Id`),
  CONSTRAINT `fk_jc_shop_dictionary_incomedesc` FOREIGN KEY (`incomedesc_id`) REFERENCES `jc_shop_dictionary` (`Id`),
  CONSTRAINT `fk_jc_shop_dictionary_userdegree` FOREIGN KEY (`userdegree_id`) REFERENCES `jc_shop_dictionary` (`Id`),
  CONSTRAINT `fk_jc_shop_dictionary_workseniority` FOREIGN KEY (`workseniority_id`) REFERENCES `jc_shop_dictionary` (`Id`),
  CONSTRAINT `fk_jc_shop_member_mgroup` FOREIGN KEY (`group_id`) REFERENCES `jc_shop_member_group` (`group_id`),
  CONSTRAINT `fk_jc_shop_member_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商城会员';

-- ----------------------------
-- Records of jc_shop_member
-- ----------------------------
INSERT INTO `jc_shop_member` VALUES ('1', '3', '1', null, null, null, null, null, null, null, null, '', '', '40', '0', '4798.00', null, '/jspgou/u/201406/18140736wuc5.jpg', null, null, null, null, null, null, null, null, null, null);
...
INSERT INTO `jc_shop_member` VALUES ('6', '1', '1', null, null, null, null, null, null, null, null, null, null, '0', null, null, null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `jc_shop_member` VALUES ('7', '1', '1', null, null, null, null, null, null, null, null, null, null, '0', null, null, null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `jc_shop_member` VALUES ('8', '1', '1', '1', '6', '10', '22', '16', 'test', '1', '2008-02-05', '18607557941', '', '0', '0', null, '', '', null, '0', '', '', null, '', '', '', '', '');

-- ----------------------------
-- Table structure for jc_shop_member_address
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_member_address`;
CREATE TABLE `jc_shop_member_address` (
  ...
  CONSTRAINT `fk_jc_address_city` FOREIGN KEY (`city_id`) REFERENCES `jc_address` (`Id`),
  CONSTRAINT `fk_jc_address_country` FOREIGN KEY (`country_id`) REFERENCES `jc_address` (`Id`),
  CONSTRAINT `fk_jc_address_member` FOREIGN KEY (`member_id`) REFERENCES `jc_shop_member` (`member_id`),
  CONSTRAINT `fk_jc_address_province` FOREIGN KEY (`province_id`) REFERENCES `jc_address` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='地址';

-- ----------------------------
-- Records of jc_shop_member_address
-- ----------------------------
INSERT INTO `jc_shop_member_address` VALUES ('1', '1', '1', '7', '8', 'test', '1', 'test', '1111111', '11111111111111', '', '', '', '0');

-- ----------------------------
-- Table structure for jc_shop_member_coupon
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_member_coupon`;
...
-- ----------------------------
-- Records of jc_shop_member_coupon
-- ----------------------------
INSERT INTO `jc_shop_member_coupon` VALUES ('1', null, '1', '1', '1');

-- ----------------------------
-- Table structure for jc_shop_member_favorite
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_member_favorite`;
CREATE TABLE `jc_shop_member_favorite` (
  ...
  CONSTRAINT `fk_jc_shop_favorite_member` FOREIGN KEY (`member_id`) REFERENCES `jc_shop_member` (`member_id`),
  CONSTRAINT `fk_jc_shop_favorite_product` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品收藏夹';

-- ----------------------------
-- Records of jc_shop_member_favorite
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_member_group
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_member_group`;
CREATE TABLE `jc_shop_member_group` (
  ...
  CONSTRAINT `fk_jc_shop_mgroup_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='商城会员组';

-- ----------------------------
-- Records of jc_shop_member_group
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_money
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_money`;
CREATE TABLE `jc_shop_money` (
  ...
  CONSTRAINT `fk_jc_shop_money_member` FOREIGN KEY (`member_id`) REFERENCES `jc_shop_member` (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='账户记录';

-- ----------------------------
-- Records of jc_shop_money
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_order
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_order`;
CREATE TABLE `jc_shop_order` (
  ...
  CONSTRAINT `fk_jc_shop_order_member` FOREIGN KEY (`member_id`) REFERENCES `jc_shop_member` (`member_id`),
  CONSTRAINT `fk_jc_shop_order_payment` FOREIGN KEY (`payment_id`) REFERENCES `jc_shop_payment` (`payment_id`),
  CONSTRAINT `fk_jc_shop_order_shipping` FOREIGN KEY (`shipping_id`) REFERENCES `jc_shop_shipping` (`shipping_id`),
  CONSTRAINT `fk_jc_shop_order_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='订单';

-- ----------------------------
-- Records of jc_shop_order
-- ----------------------------
INSERT INTO `jc_shop_order` VALUES ('1', '1', '1', '1', '1', '1423035401774', '1', '1', '1', '40000.01', '0', '0.00', '40000.01', '0', '127.0.0.1', '2015-02-04 15:36:42', null, '2015-02-04 15:36:42', '', null, null, 'null支付测试佳能EOS450D数码相机', null, null, 'test', '江西省 南昌 西湖区 test', '1111111', null, '11111111111111', null);

-- ----------------------------
-- Table structure for jc_shop_order_gathering
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_order_gathering`;
...
-- ----------------------------
-- Records of jc_shop_order_gathering
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_order_item
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_order_item`;
CREATE TABLE `jc_shop_order_item` (
  ...
  CONSTRAINT `fk_jc_shop_item_order` FOREIGN KEY (`order_id`) REFERENCES `jc_shop_order` (`order_id`),
  CONSTRAINT `fk_jc_shop_orderitem_product` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`),
  CONSTRAINT `fk_jc_shop_orderitem_productFash` FOREIGN KEY (`productFash_id`) REFERENCES `jc_shop_product_fashion` (`fashion_id`),
  CONSTRAINT `fk_jc_shop_orderitem_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='订单项';

-- ----------------------------
-- Records of jc_shop_order_item
-- ----------------------------
INSERT INTO `jc_shop_order_item` VALUES ('1', '1', '1', '4', null, '1', '0.01', null, null, null, null);
INSERT INTO `jc_shop_order_item` VALUES ('2', '1', '1', '3', null, '1', '40000.00', null, null, null, null);

-- ----------------------------
-- Table structure for jc_shop_order_return
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_order_return`;
...
-- ----------------------------
-- Records of jc_shop_order_return
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_order_return_picture
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_order_return_picture`;
CREATE TABLE `jc_shop_order_return_picture` (
  ...
  CONSTRAINT `fk_jc_shop_order_return_picture` FOREIGN KEY (`return_id`) REFERENCES `jc_shop_order_return` (`return_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='退款图片表';

-- ----------------------------
-- Records of jc_shop_order_return_picture
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_order_shipments
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_order_shipments`;
...
-- ----------------------------
-- Records of jc_shop_order_shipments
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_pay
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_pay`;
...
-- ----------------------------
-- Records of jc_shop_pay
-- ----------------------------
INSERT INTO `jc_shop_pay` VALUES ('1', '南昌×××.', '农业银行:3621×××,工商银行:121×××', '22304030', 'abcdefg');

-- ----------------------------
-- Table structure for jc_shop_payment
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_payment`;
CREATE TABLE `jc_shop_payment` (
  ...
  CONSTRAINT `fk_jc_shop_payment_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='支付方式';

-- ----------------------------
-- Records of jc_shop_payment
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_payment_plugins
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_payment_plugins`;
...
-- ----------------------------
-- Records of jc_shop_payment_plugins
-- ----------------------------
INSERT INTO `jc_shop_payment_plugins` VALUES ('2', '支付宝担保交易', '', '2', '2088702353288864', '15979004480', 'ete1cxo8q2ekad9pj0zlaejfzs9lzic8', '/jspgou/u/201408/29105140zh3l.gif', 'alipayPartner');
INSERT INTO `jc_shop_payment_plugins` VALUES ('3', '支付宝即时交易', '', '1', '2088702353288864', '15979004480', 'ete1cxo8q2ekad9pj0zlaejfzs9lzic8', '/jspgou/u/201408/291039531mhu.gif', 'alipay');

-- ----------------------------
-- Table structure for jc_shop_payment_shipping
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_payment_shipping`;
...
-- ----------------------------
-- Records of jc_shop_payment_shipping
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_poster
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_poster`;
...
-- ----------------------------
-- Records of jc_shop_poster
-- ----------------------------
INSERT INTO `jc_shop_poster` VALUES ('2', '/jspgou/u/201405/26084133ztri.jpg', '2014-05-26 08:44:12', '');
INSERT INTO `jc_shop_poster` VALUES ('3', '/jspgou/u/201405/26084242g27o.jpg', '2014-05-26 08:44:12', '');
INSERT INTO `jc_shop_poster` VALUES ('4', '/jspgou/u/201405/260843018b66.jpg', '2014-05-26 08:44:12', '');
INSERT INTO `jc_shop_poster` VALUES ('5', '/jspgou/u/201405/2608432911kh.jpg', '2014-05-26 08:44:12', '');
INSERT INTO `jc_shop_poster` VALUES ('6', '/jspgou/u/201407/21110157fyil.jpg', '2014-07-21 11:02:00', '');

-- ----------------------------
-- Table structure for jc_shop_product
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_product`;
CREATE TABLE `jc_shop_product` (
  ...
  CONSTRAINT `fk_jc_shop_product_brand` FOREIGN KEY (`brand_id`) REFERENCES `jc_shop_brand` (`brand_id`),
  CONSTRAINT `fk_jc_shop_product_category` FOREIGN KEY (`category_id`) REFERENCES `jc_shop_category` (`category_id`),
  CONSTRAINT `fk_jc_shop_product_config` FOREIGN KEY (`config_id`) REFERENCES `jc_shop_config` (`config_id`),
  CONSTRAINT `fk_jc_shop_product_ptype` FOREIGN KEY (`ptype_id`) REFERENCES `jc_shop_ptype` (`ptype_id`),
  CONSTRAINT `fk_jc_shop_product_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='商品';

-- ----------------------------
-- Records of jc_shop_product
-- ----------------------------
INSERT INTO `jc_shop_product` VALUES ('1', '8', '3', '3', '1', '1', '苹果4S', '2348.00', '2248.00', '1248.00', '25', '0', '144', null, '2014-06-18 14:32:34', null, '1', '0', '0', '0', '0', '0', '', '1', '0.00');
INSERT INTO `jc_shop_product` VALUES ('2', '9', '15', '5', '1', '1', '华硕R510VC', '4000.00', '3399.00', '2399.00', '4', '0', '45', null, '2014-06-18 14:52:41', null, '1', '0', '0', '0', '0', '0', '', '1', '0.00');
INSERT INTO `jc_shop_product` VALUES ('3', '1', '6', '12', '1', '1', '佳能EOS450D数码相机', '50000.00', '40000.00', '10000.00', '5', '0', '7', null, '2014-06-18 15:48:20', null, '1', '0', '0', '0', '0', '0', '', '1', '0.00');
INSERT INTO `jc_shop_product` VALUES ('4', '1', '1', '11', '1', '1', '支付测试', '0.01', '0.01', '0.01', '19', '12', '112', null, '2014-08-19 14:00:48', null, '1', '0', '0', '0', '0', '0', '', '1', '0.00');
INSERT INTO `jc_shop_product` VALUES ('7', '12', '3', '22', '1', '1', '3D电影票', '30.00', '30.00', '30.00', '6', '0', '22', null, '2015-02-04 16:02:48', null, '1', '0', '0', '0', '0', '0', '3D电影票', '1', '0.00');

-- ----------------------------
-- Table structure for jc_shop_product_attr
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_product_attr`;
CREATE TABLE `jc_shop_product_attr` (
  `product_id` bigint(20) NOT NULL DEFAULT '0',
  `attr_name` varchar(30) NOT NULL DEFAULT '' COMMENT '名称',
  `attr_value` varchar(255) DEFAULT NULL COMMENT '值',
  KEY `fK_jc_shop_product_attr` (`product_id`),
  CONSTRAINT `fk_jc_shop_product_attr` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='jspgou商品扩展属性表';

-- ----------------------------
-- Records of jc_shop_product_attr
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_product_exended
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_product_exended`;
...
-- ----------------------------
-- Records of jc_shop_product_exended
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_product_ext
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_product_ext`;
CREATE TABLE `jc_shop_product_ext` (
  ...
  `seckillprice` double(11,2) DEFAULT NULL COMMENT '秒杀价',
  PRIMARY KEY (`product_id`),
  CONSTRAINT `fk_jc_shop_ext_product` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of jc_shop_product_ext
-- ----------------------------
INSERT INTO `jc_shop_product_ext` VALUES ('1', '20140618143235', null, '', '', '', null, null, null, '/jspgou/u/201406/181425267rxb.jpg', '0', '', null, null, null, null, null);
INSERT INTO `jc_shop_product_ext` VALUES ('2', '20140618145243', null, '', '', '', null, null, null, '/jspgou/u/201406/18144920vgvt.jpg', '0', '', null, null, null, null, null);
INSERT INTO `jc_shop_product_ext` VALUES ('3', '20140618154823', null, '', '', '', null, null, null, '/jspgou/u/201406/18155613n1i8.jpg', '0', '', null, null, null, null, null);
INSERT INTO `jc_shop_product_ext` VALUES ('4', '20140819140052', null, '', '', '', null, null, null, '/jspgou/u/201408/20094626rwjs.jpg', '0', '', null, null, null, null, null);
INSERT INTO `jc_shop_product_ext` VALUES ('7', '20150204160254', null, '3D电影票', '3D电影票', '3D电影票', null, null, null, '/jspgou/u/201502/04160206wdft.jpg', '1', '', null, null, null, null, null);

-- ----------------------------
-- Table structure for jc_shop_product_fashion
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_product_fashion`;
CREATE TABLE `jc_shop_product_fashion` (
  ...
  CONSTRAINT `fk_fashion_product` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='商品款式';

-- ----------------------------
-- Records of jc_shop_product_fashion
-- ----------------------------
INSERT INTO `jc_shop_product_fashion` VALUES ('1', '1', '12', null, '2014-08-28 17:23:39', '2499.00', '2399.00', '1499.00', null, '0', null, '1', null, null, null, '0', '23_25_28', ' 白 电信3G 0元购机');
INSERT INTO `jc_shop_product_fashion` VALUES ('2', '1', '12', null, '2014-08-28 17:23:39', '2348.00', '2248.00', '1248.00', null, '0', null, '1', null, null, null, '0', '23_25_27', ' 白 电信3G 购机入网送话费');
INSERT INTO `jc_shop_product_fashion` VALUES ('3', '1', '12', null, '2014-08-28 17:23:39', '2498.00', '2398.00', '1498.00', null, '0', null, '1', null, null, null, '0', '23_25_26', ' 白 电信3G 非合约机');
INSERT INTO `jc_shop_product_fashion` VALUES ('4', '1', '12', null, '2014-08-28 17:23:39', '2499.00', '2399.00', '1499.00', null, '0', null, '1', null, null, null, '0', '23_24_28', ' 白 联通3G 0元购机');
INSERT INTO `jc_shop_product_fashion` VALUES ('5', '1', '12', null, '2014-08-28 17:23:39', '2348.00', '2248.00', '1248.00', null, '0', null, '1', null, null, null, '0', '23_24_27', ' 白 联通3G 购机入网送话费');
INSERT INTO `jc_shop_product_fashion` VALUES ('6', '1', '12', null, '2014-08-28 17:23:39', '2498.00', '2398.00', '1498.00', null, '0', null, '1', null, null, null, '0', '23_24_26', ' 白 联通3G 非合约机');
INSERT INTO `jc_shop_product_fashion` VALUES ('7', '1', '12', null, '2014-08-28 17:23:39', '2499.00', '2399.00', '1499.00', null, '0', null, '1', null, null, null, '0', '22_25_28', ' 黑 电信3G 0元购机');
INSERT INTO `jc_shop_product_fashion` VALUES ('8', '1', '12', null, '2014-08-28 17:23:39', '2348.00', '2248.00', '1248.00', null, '0', null, '1', null, null, null, '1', '22_25_27', ' 黑 电信3G 购机入网送话费');
INSERT INTO `jc_shop_product_fashion` VALUES ('9', '1', '12', null, '2014-08-28 17:23:40', '2498.00', '2398.00', '1498.00', null, '0', null, '1', null, null, null, '0', '22_25_26', ' 黑 电信3G 非合约机');
INSERT INTO `jc_shop_product_fashion` VALUES ('10', '1', '12', null, '2014-08-28 17:23:39', '2499.00', '2399.00', '1499.00', null, '0', null, '1', null, null, null, '0', '22_24_28', ' 黑 联通3G 0元购机');
INSERT INTO `jc_shop_product_fashion` VALUES ('11', '1', '12', null, '2014-08-28 17:23:39', '2348.00', '2248.00', '1248.00', null, '0', null, '1', null, null, null, '0', '22_24_27', ' 黑 联通3G 购机入网送话费');
INSERT INTO `jc_shop_product_fashion` VALUES ('12', '1', '12', null, '2014-08-28 17:23:39', '2498.00', '2398.00', '1498.00', null, '0', null, '1', null, null, null, '0', '22_24_26', ' 黑 联通3G 非合约机');
INSERT INTO `jc_shop_product_fashion` VALUES ('13', '2', '9', null, '2014-08-28 17:25:52', '4000.00', '3399.00', '2399.00', null, '0', null, '1', null, null, null, '1', '30', ' i3-3110M GT710M');
INSERT INTO `jc_shop_product_fashion` VALUES ('14', '2', '12', null, '2014-08-28 17:25:53', '5000.00', '4399.00', '3399.00', null, '0', null, '1', null, null, null, '0', '29', ' i5-3230M 750G 蓝牙');
INSERT INTO `jc_shop_product_fashion` VALUES ('15', '2', '12', null, '2014-08-28 17:25:52', '6000.00', '5399.00', '4399.00', null, '0', null, '1', null, null, null, '0', '32', ' i5-3230M 500G');
INSERT INTO `jc_shop_product_fashion` VALUES ('16', '2', '12', null, '2014-08-28 17:25:52', '7000.00', '6399.00', '5399.00', null, '0', null, '1', null, null, null, '0', '31', ' i5-4200U 高速硬盘 GT820M 蓝牙');

-- ----------------------------
-- Table structure for jc_shop_product_keyword
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_product_keyword`;
CREATE TABLE `jc_shop_product_keyword` (
  `product_id` bigint(20) NOT NULL,
  `name` varchar(100) NOT NULL,
  `priority` int(11) NOT NULL,
  KEY `fk_jc_shop_keyword_product` (`product_id`),
  CONSTRAINT `fk_jc_shop_keyword_product` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品关键字';

-- ----------------------------
-- Records of jc_shop_product_keyword
-- ----------------------------
INSERT INTO `jc_shop_product_keyword` VALUES ('7', '3D电影票', '0');

-- ----------------------------
-- Table structure for jc_shop_product_picture
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_product_picture`;
...
-- ----------------------------
-- Records of jc_shop_product_picture
-- ----------------------------
INSERT INTO `jc_shop_product_picture` VALUES ('1', '0', '/jspgou/u/201406/18142536tneg.jpg', '/jspgou/u/201406/18142544h0ef.jpg', '/jspgou/u/201406/181425514q7u.jpg');
INSERT INTO `jc_shop_product_picture` VALUES ('1', '1', '/jspgou/u/201406/1814260034lw.jpg', '/jspgou/u/201406/18142607gpvs.jpg', '/jspgou/u/201406/18142615rnpc.jpg');
INSERT INTO `jc_shop_product_picture` VALUES ('2', '0', '/jspgou/u/201406/18145136za92.jpg', '/jspgou/u/201406/181451411694.jpg', '/jspgou/u/201406/181451469xgz.jpg');
INSERT INTO `jc_shop_product_picture` VALUES ('3', '0', '/jspgou/u/201406/181556207hte.jpg', '/jspgou/u/201406/18155625wpur.jpg', '/jspgou/u/201406/18155631rqkw.jpg');
INSERT INTO `jc_shop_product_picture` VALUES ('4', '0', '/jspgou/u/201408/20094626rwjs.jpg', '/jspgou/u/201408/20094626rwjs.jpg', '/jspgou/u/201408/20094626rwjs.jpg');
INSERT INTO `jc_shop_product_picture` VALUES ('7', '0', '/jspgou/u/201502/04160211lxl3.jpg', '/jspgou/u/201502/04160216s4za.jpg', '/jspgou/u/201502/04160222kz3w.jpg');

-- ----------------------------
-- Table structure for jc_shop_product_standard
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_product_standard`;
CREATE TABLE `jc_shop_product_standard` (
  ...
  CONSTRAINT `fk_jc_shop_product_standard` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=110 DEFAULT CHARSET=utf8 COMMENT='商品规则存储表';

-- ----------------------------
-- Records of jc_shop_product_standard
-- ----------------------------
INSERT INTO `jc_shop_product_standard` VALUES ('99', '1', '23', '1', '3', '/jspgou/u/201406/181426427yjv.jpg');
INSERT INTO `jc_shop_product_standard` VALUES ('100', '1', '22', '1', '3', '/jspgou/u/201406/18142633mkyr.jpg');
...
-- ----------------------------
-- Table structure for jc_shop_product_tag
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_product_tag`;
CREATE TABLE `jc_shop_product_tag` (
  ...
  CONSTRAINT `fk_jc_shop_product_tag` FOREIGN KEY (`stag_id`) REFERENCES `jc_shop_tag` (`stag_id`),
  CONSTRAINT `fk_jc_shop_tag_product` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of jc_shop_product_tag
-- ----------------------------

-- ----------------------------
-- Table structure for jc_shop_product_text
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_product_text`;
CREATE TABLE `jc_shop_product_text` (
  ...
  `text2` longtext,
  PRIMARY KEY (`product_id`),
  CONSTRAINT `fk_jc_shop_text_product` FOREIGN KEY (`product_id`) REFERENCES `jc_shop_product` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品详情';

-- ----------------------------
-- Records of jc_shop_product_text
-- ----------------------------
INSERT INTO `jc_shop_product_text` VALUES ('1', '<p style=\"text-align: center\">双核，让 A5 芯片双倍强大，图形处理快达 7 倍1。你会感觉到它所带来的效果 &mdash; 飞快。iPhone 4S 快速，反应灵敏，当你启动应用软件、浏览网页，以及做各种操作时，就会体验到它所成就的与众不同。而且无论你正在做什么，都可以持续进行。A5 芯片具有极高的效能，赋予 iPhone 4S 超长的电池使用时间。<img alt=\"\" src=\"/jspgou/u/jspgou//201406/18143137t4t5.jpg\" style=\"width: 743px; height: 328px\" /></p>', '<p style=\"text-align: center\">这可能是迄今最出色的手机摄像头。配备全新光学技术的它，或许就是你所需要的唯一一部相机。您可以使用 800 万像素高分辨率和具有更大光圈的 f/2.4 定制镜头拍摄，还有更先进的背部照度传感器、出色的自动白平衡功能、更理想的色彩保真度和面部检测，图像模糊的情况也会减少。这一切都意味着，无论有多少人，多少光线，你捕捉了多少动作，每张照片都会呈现其真实本色。等着看照片吧。<img alt=\"\" src=\"/jspgou/u/jspgou//201406/18143204tvoa.jpg\" style=\"width: 750px; height: 371px\" /></p>', null);
INSERT INTO `jc_shop_product_text` VALUES ('2', '<p style=\"text-align: center\"><img alt=\"\" src=\"/jspgou/u/jspgou//201406/18145208dqsc.jpg\" style=\"width: 750px; height: 509px\" /></p>', '<p style=\"text-align: center\"><img alt=\"\" src=\"/jspgou/u/jspgou//201406/18145222aer4.jpg\" style=\"width: 750px; height: 439px\" /></p>', null);
INSERT INTO `jc_shop_product_text` VALUES ('3', '<p style=\"text-align: center\"><img alt=\"\" src=\"/jspgou/u/jspgou//201406/1815505964wi.jpg\" style=\"width: 750px; height: 300px\" /></p>', '<p style=\"text-align: center\"><img alt=\"\" src=\"/jspgou/u/jspgou//201406/18155120tdqq.jpg\" style=\"width: 750px; height: 371px\" /></p>', null);
INSERT INTO `jc_shop_product_text` VALUES ('4', '', '', null);
INSERT INTO `jc_shop_product_text` VALUES ('7', '<p>3D电影票</p>', '<p>3D电影票</p>', null);

-- ----------------------------
-- Table structure for jc_shop_ptype
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_ptype`;
CREATE TABLE `jc_shop_ptype` (
  ...
  CONSTRAINT `fk_jc_shop_ptype_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='商品类型';

-- ----------------------------
-- Records of jc_shop_ptype
-- ----------------------------
...
INSERT INTO `jc_shop_ptype` VALUES ('12', '1', '电影票', null, null, '分类', '电影票', null, '310', '310', '140', '140', '100', '100');

-- ----------------------------
-- Table structure for jc_shop_ptype_exended
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_ptype_exended`;
...
-- ----------------------------
-- Records of jc_shop_ptype_exended
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_shop_ptype_property
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_ptype_property`;
CREATE TABLE `jc_shop_ptype_property` (
  ...
  CONSTRAINT `fk_type_property` FOREIGN KEY (`ptype_id`) REFERENCES `jc_shop_ptype` (`ptype_id`)
) ENGINE=InnoDB AUTO_INCREMENT=472 DEFAULT CHARSET=utf8 COMMENT='商品类型属性表';

-- ----------------------------
-- Records of jc_shop_ptype_property
-- ----------------------------
...
INSERT INTO `jc_shop_ptype_property` VALUES ('441', '12', 'name', '分类名称', '10', null, null, null, null, null, null, '1', '0', '1', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('442', '12', 'path', '访问路径', '10', null, null, null, null, null, null, '1', '0', '1', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('443', '12', 'title', '页面标题', '10', null, null, null, null, null, null, '1', '0', '1', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('444', '12', 'keywords', '页面关键词', '10', null, null, null, null, null, null, '1', '0', '1', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('445', '12', 'description', '页面描述', '10', null, null, null, null, null, null, '4', '1', '1', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('446', '12', 'tplChannel', '分类模板', '10', null, null, null, null, null, null, '6', '0', '1', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('447', '12', 'tplContent', '商品模板', '10', null, null, null, null, null, null, '6', '0', '1', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('448', '12', 'priority', '排序', '10', null, null, null, null, null, null, '2', '1', '1', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('449', '12', 'image', '图片', '10', null, null, null, null, null, null, '1', '1', '1', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('450', '12', 'refBrand', '关联品牌', '10', null, null, null, null, null, null, '7', '1', '1', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('451', '12', 'standardTypeIds', '扩展属性', '10', null, null, null, null, null, null, '7', '1', '1', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('452', '12', 'colorsize', '规格', '10', null, null, null, null, null, null, '7', '1', '1', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('453', '12', 'name', '商品名称', '10', null, null, null, null, null, null, '1', '1', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('454', '12', 'categoryId', '分类', '10', null, null, null, null, null, null, '6', '0', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('455', '12', 'brandId', '品牌', '10', null, null, null, null, null, null, '6', '0', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('456', '12', 'price', '价格', '10', null, null, null, null, null, null, '2', '1', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('457', '12', 'stockCount', '商品库存', '10', null, null, null, null, null, null, '2', '1', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('458', '12', 'weight', '商品重量', '10', null, null, null, null, null, null, '2', '1', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('459', '12', 'attr', '设置', '10', null, null, null, null, null, null, '7', '1', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('460', '12', 'score', '可得积分', '10', null, null, null, null, null, null, '2', '0', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('461', '12', 'alertInventory', '警戒库存', '10', null, null, null, null, null, null, '2', '0', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('462', '12', 'tagIds', '标签', '10', null, null, null, null, null, null, '7', '1', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('463', '12', 'coverImg', '封面图片', '10', null, null, null, null, null, null, '1', '0', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('464', '12', 'productstyle', '商品款式集', '10', null, null, null, null, null, null, '1', '0', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('465', '12', 'shareContent', '分享内容', '10', null, null, null, null, null, null, '4', '1', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('466', '12', 'mtitle', '页面标题', '10', null, null, null, null, null, null, '1', '1', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('467', '12', 'productKeywords', '关键字', '10', null, null, null, null, null, null, '1', '1', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('468', '12', 'mkeywords', '页面关键字', '10', null, null, null, null, null, null, '1', '1', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('469', '12', 'mdescription', '页面描述', '10', null, null, null, null, null, null, '1', '1', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('470', '12', 'text', '商品详情', '10', null, null, null, null, null, null, '4', '1', '0', '0');
INSERT INTO `jc_shop_ptype_property` VALUES ('471', '12', 'text1', '售后服务', '10', null, null, null, null, null, null, '4', '1', '0', '0');

-- ----------------------------
-- Table structure for jc_shop_score
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_score`;
CREATE TABLE `jc_shop_score` (
  ...
  CONSTRAINT `fk_jc_shop_score_member` FOREIGN KEY (`member_id`) REFERENCES `jc_shop_member` (`member_id`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COMMENT='积分明细';

-- ----------------------------
-- Records of jc_shop_score
-- ----------------------------
...
INSERT INTO `jc_shop_score` VALUES ('57', '1', 'test', '0', '2014-10-15 10:24:04', '11', '0', '0', null, '1413339843969');
INSERT INTO `jc_shop_score` VALUES ('58', '1', 'test', '0', '2014-10-15 10:24:04', '11', '0', '0', null, '1413339843969');
INSERT INTO `jc_shop_score` VALUES ('59', '1', 'test', '0', '2014-10-15 10:24:04', '11', '0', '0', null, '1413339843969');
INSERT INTO `jc_shop_score` VALUES ('60', '1', 'test', '0', '2014-10-15 10:27:09', '11', '0', '0', null, '1413340029594');
INSERT INTO `jc_shop_score` VALUES ('61', '1', 'test', '0', '2014-10-31 13:43:35', '11', '0', '0', null, '1414734215797');
INSERT INTO `jc_shop_score` VALUES ('62', '1', 'test', '0', '2014-10-31 13:43:35', '11', '0', '0', null, '1414734215797');
INSERT INTO `jc_shop_score` VALUES ('63', '1', 'test', '0', '2014-10-31 15:13:37', '11', '0', '0', null, '1414739617516');
INSERT INTO `jc_shop_score` VALUES ('64', '1', 'test', '0', '2014-10-31 15:13:37', '11', '0', '0', null, '1414739617516');
INSERT INTO `jc_shop_score` VALUES ('65', '1', '佳能EOS450D数码相机', '0', '2015-02-04 15:36:42', '11', '0', '0', null, '1423035401774');
INSERT INTO `jc_shop_score` VALUES ('66', '1', '佳能EOS450D数码相机', '0', '2015-02-04 15:36:42', '11', '0', '0', null, '1423035401774');

-- ----------------------------
-- Table structure for jc_shop_shipping
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_shipping`;
CREATE TABLE `jc_shop_shipping` (
  ...
  CONSTRAINT `fk_jc_shop_shipping_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='发货方式';

-- ----------------------------
-- Records of jc_shop_shipping
-- ----------------------------
INSERT INTO `jc_shop_shipping` VALUES ('1', '1', '普通快递', '系统将根据您的收货地址自动匹配快递公司进行配送，享受免运费服务', '0.00', '1', '1.00', '1', '1.00', '1', '1', '0', '1', '4', 'EXPRESS');
INSERT INTO `jc_shop_shipping` VALUES ('2', '1', '顺丰快递', '需支付10元配送费用，不享受免运费服务', '10.00', '500', '20.00', '500', '10.00', '1', '2', '0', '0', '5', 'EXPRESS');

-- ----------------------------
-- Table structure for jc_shop_tag
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_tag`;
CREATE TABLE `jc_shop_tag` (
  ...
  CONSTRAINT `fk_jc_shop_tag_website` FOREIGN KEY (`website_id`) REFERENCES `jc_core_website` (`website_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='标签';

-- ----------------------------
-- Records of jc_shop_tag
-- ----------------------------
INSERT INTO `jc_shop_tag` VALUES ('1', '1', '惠民', '28');

-- ----------------------------
-- Table structure for jc_shop_weixin
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_weixin`;
CREATE TABLE `jc_shop_weixin` (
  `weixin_id` bigint(1) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of jc_shop_weixin
-- ----------------------------
INSERT INTO `jc_shop_weixin` VALUES ('1', 'eeeeeeeeeee', 'eeeeeeeeeee', 'testeeeeeee', 'eeeeeeeeeee');

-- ----------------------------
-- Table structure for jc_shop_weixinmenu
-- ----------------------------
DROP TABLE IF EXISTS `jc_shop_weixinmenu`;
CREATE TABLE `jc_shop_weixinmenu` (
  `weixinmenu_id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  `parent_id` bigint(20) DEFAULT NULL COMMENT '父节点',
  PRIMARY KEY (`weixinmenu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of jc_shop_weixinmenu
-- ----------------------------
INSERT INTO `jc_shop_weixinmenu` VALUES ('1', 'test', 'click', 'dddddeddd', 'ddddd', null);
INSERT INTO `jc_shop_weixinmenu` VALUES ('2', 'ddddddddddd', 'click', 'dddddddddddd', 'dddddddddddd', '1');

-- ----------------------------
-- Table structure for jc_standard
-- ----------------------------
DROP TABLE IF EXISTS `jc_standard`;
CREATE TABLE `jc_standard` (
  ...
  CONSTRAINT `fc_jc_standard_type` FOREIGN KEY (`type_id`) REFERENCES `jc_standard_type` (`standardtype_id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='商品规格表';

-- ----------------------------
-- Records of jc_standard
-- ----------------------------
...
-- ----------------------------
-- Table structure for jc_standard_type
-- ----------------------------
DROP TABLE IF EXISTS `jc_standard_type`;
