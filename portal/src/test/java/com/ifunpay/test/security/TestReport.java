...
public class TestReport {
    ...
    @Test
    public void testFetchMerchantReport() {
        Map<String, Object> request = new HashMap<>();
        Map<String, Object> filters = new HashMap<>();
        filters.put("channelId", "");
        filters.put("channelName", "");
        filters.put("merchantId", "");
        filters.put("merchantName", "");
        filters.put("startTime", "2015-04-16 8:00:50");
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        filters.put("endTime", sdf.format(new Date()));
        request.putIfAbsent("filters", filters);
        request.put("start", 1);
        request.put("size", 10);
        request.put("sortField", "merchantId");
        ...
        client.addHeader("timestamp", time + "");
        client.addHeader("appKey", appKey);
        String response = client.postJson(baseUrl + "/fetchMerchantReport", json);
        System.out.println(response);
        Assert.assertNotNull(response);
    }

    @Test
    public void testFetchVendorReport() {
        Map<String, Object> request = new HashMap<>();
        Map<String, Object> filters = new HashMap<>();
        filters.put("channelId", "");
        filters.put("channelName", "");
        ...
        client.addHeader("timestamp", time + "");
        client.addHeader("appKey", appKey);
//        String response = client.postJson(baseUrl + "/fetchVendorReport", json);
        String response = client.postJson(baseUrl + "/fetchVendorReportRmb", json);
        System.out.println(response);
        Assert.assertNotNull(response);
    }

    @Test
    public void testFetchProductReport() {
        Map<String, Object> request = new HashMap<>();
        Map<String, Object> filters = new HashMap<>();
        filters.put("channelId", "");
        filters.put("channelName", "");
        filters.put("merchantId", "");
        filters.put("merchantName", "");
        filters.put("productId", "");
        filters.put("productName", "");
        filters.put("startTime", "2015-04-16 8:00:50");
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        filters.put("endTime", sdf.format(new Date()));
        request.putIfAbsent("filters", filters);
        ...
        client.addHeader("timestamp", time + "");
        client.addHeader("appKey", appKey);
//        String response = client.postJson(baseUrl + "/fetchProductReport", json);
        String response = client.postJson(baseUrl + "/fetchProductReportRmb", json);
        System.out.println(response);
        Assert.assertNotNull(response);
    }
