 ...
 * Parameters:
 * <ul>
 * <li><code>count</code>: The number of repetations. Required! Must be a
 * non-negative number. If it is not a whole number then it will be rounded
 * <em>down</em>.
 ...
 * 
 * <p>
 * Loop variables: One, optional. It gives the number of the current repetation,
 * starting from 1.
 * 
 * <p>
 * Nested content: Yes
...
public class RepeatDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		Iterator<Map.Entry<String, TemplateModel>> paramIter = params
				.entrySet().iterator();
		while (paramIter.hasNext()) {
			Map.Entry<String, TemplateModel> ent = (Map.Entry<String, TemplateModel>) paramIter
					.next();
