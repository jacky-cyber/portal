...
TRUNCATE n_order_pay_refund;
TRUNCATE n_order_product;
TRUNCATE t_n_voucher;
TRUNCATE n_order;


TRUNCATE jc_shop_ptype_property;
TRUNCATE jc_shop_category_sdtype;

TRUNCATE jc_shop_product_attr;
TRUNCATE jc_shop_product_exended;
TRUNCATE jc_shop_product_ext;
TRUNCATE jc_shop_product_standard;
TRUNCATE jc_shop_fashion_standard;
TRUNCATE jc_shop_product_fashion;
TRUNCATE jc_shop_product_favorable;
TRUNCATE jc_shop_product_keyword;
TRUNCATE jc_shop_product_picture;

TRUNCATE jc_shop_product_tag;
TRUNCATE jc_shop_product_text;
TRUNCATE jc_shop_cart_item;
TRUNCATE jc_shop_order_item;
TRUNCATE jc_shop_product;
TRUNCATE jc_shop_category_brand;
TRUNCATE jc_shop_category;
TRUNCATE jc_shop_ptype;
TRUNCATE jc_shop_ptype_exended;
...
--Author Conglong Xie 2015年8月24日 19:19:42
-- add index
ALTER TABLE n_order ADD INDEX idx_phone (phone);
ALTER TABLE n_order ADD INDEX idx_order_id (order_id);
ALTER TABLE n_order ADD INDEX idx_pay_status (pay_status);
ALTER TABLE n_order ADD INDEX idx_order_status (order_status);
ALTER TABLE n_order ADD INDEX idx_create_time (create_time);
ALTER TABLE n_order ADD INDEX idx_terminal_id (terminal_id);
ALTER TABLE n_order ADD INDEX idx_del (del);


ALTER TABLE n_order_pay_refund ADD INDEX idx_order_number (order_number);
ALTER TABLE n_order_pay_refund ADD INDEX idx_is_pay (is_pay);

ALTER TABLE n_order_product ADD INDEX idx_order_number (order_number);

ALTER TABLE t_n_voucher ADD INDEX idx_order_number (order_number);
ALTER TABLE t_n_voucher ADD INDEX idx_voucher_code (VOUCHER_CODE);

ALTER TABLE n_order_post_info ADD INDEX idx_order_number (order_number);

--Author Conglong Xie
--Date 2015年8月31日 10:02:30
--add feed back of shipping for new order
alter TABLE n_order add feed_back VARCHAR(200) COMMENT '出货结果反馈';